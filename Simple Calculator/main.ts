...
const answer = await inquirer.prompt([ // A questionnaire for user to store input  in "answer" variable
...
if (answer.operator === "Addition") { //If user selective operator is equal to addition 
  ...
  console.log("please select valid operator"); //Then print this message
